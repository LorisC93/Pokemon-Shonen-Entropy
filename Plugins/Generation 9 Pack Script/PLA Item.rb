...
# Poke Ball Items
#===============================================================================
Battle::PokeBallEffects::ModifyCatchRate.add(:HPOKEBALL, proc { |ball, catchRate, battle, battler|
  next catchRate * 0.75
})

Battle::PokeBallEffects::ModifyCatchRate.add(:HGREATBALL, proc { |ball, catchRate, battle, battler|
  next catchRate * 1.5
})

Battle::PokeBallEffects::ModifyCatchRate.add(:HULTRABALL, proc { |ball, catchRate, battle, battler|
  next catchRate * 2.25
})
...
Battle::PokeBallEffects::ModifyCatchRate.add(:HHEAVYBALL, proc { |ball, catchRate, battle, battler|
  next catchRate * 1
})
