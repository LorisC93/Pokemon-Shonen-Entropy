...
#===============================================================================
class Pokemon
  attr_reader :used_move_count, :step_count, :defeated_species, :recoil_dmg_taken
...
# Recoil and used move count method for basculin, wyrdeer, and primeape
class Battle::Battler
  alias count_pbUseMove pbUseMove
  def pbUseMove(choice, specialUsage = false)
    ...
    count_pbUseMove(choice, specialUsage)
    # Use Move
